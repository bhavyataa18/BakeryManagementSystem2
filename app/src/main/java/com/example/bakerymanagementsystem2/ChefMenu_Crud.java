...
public class ChefMenu_Crud extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chef_menu_crud);
        ...
        dataa.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Delete_dish.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(ChefMenu_Crud.this);
                        ...
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                AlertDialog.Builder food = new AlertDialog.Builder(ChefMenu_Crud.this);
                                food.setMessage("Your Dish Has Been Deleted!");
                                food.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        startActivity(new Intent(ChefMenu_Crud.this, ChefFoodPanel_BottomNavigation.class));
                                    }
                                });
                ...
                progressDialog = new ProgressDialog(ChefMenu_Crud.this);
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        desc.getEditText().setText(((UpdateDishModel) updateDishModel).getDescription());
                        ...
                        Glide.with(ChefMenu_Crud.this).load(updateDishModel.getImageURL()).into(imageButton);
    ...
    private void updatedesc(String buri) {
        ...
        firebaseDatabase.getInstance().getReference("FoodDetails").child(State).child(City).child(Area)
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                Toast.makeText(ChefMenu_Crud.this,"Dish Updates Successfully!",Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        if(imageuri != null){
            ...
            ref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    progressDialog.dismiss();
                    Toast.makeText(ChefMenu_Crud.this,"Failed:"+e.getMessage(),Toast.LENGTH_LONG).show();
                }
